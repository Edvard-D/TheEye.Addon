TheEyeAddon.Events.Evaluators.UIOBJECT_FRAME_VISIBLE_CHANGED = {}
local this = TheEyeAddon.Events.Evaluators.UIOBJECT_FRAME_VISIBLE_CHANGED
this.name = "UIOBJECT_FRAME_VISIBLE_CHANGED"
